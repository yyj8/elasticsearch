 ...
 */
class Elasticsearch5 extends EnvironmentAwareCommand {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        System.setProperty("es.path.home","D:\\workspace\\github\\yyj8\\elasticsearch\\cluster\\es5");
        System.setProperty("es.path.conf","D:\\workspace\\github\\yyj8\\elasticsearch\\cluster\\es5\\config");
        System.setProperty("log4j2.disable.jmx", "true"); // 禁用 log4j2 的 JMX 监控，避免报错
        // 设置 Java 的安全策略
        System.setProperty("java.security.policy","D:\\workspace\\github\\yyj8\\elasticsearch\\cluster\\es5\\config\\java.policy");
        ...
        final Elasticsearch5 elasticsearch = new Elasticsearch5();
    ...
    static int main(final String[] args, final Elasticsearch5 elasticsearch, final Terminal terminal) throws Exception {
