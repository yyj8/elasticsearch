 ...
 */
class Elasticsearch1 extends EnvironmentAwareCommand {
    ...
    static int main(final String[] args, final Elasticsearch1 elasticsearch, final Terminal terminal) throws Exception {
